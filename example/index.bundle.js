...
var Player = function () {
  ...
  _createClass(Player, [{
    ...
    value: function pause() {
      ...
      return new Promise(function (resolve, reject) {
        if (_this8._context.state === 'running') {
